...
var Modal = /*#__PURE__*/function () {
  function Modal() {
    ...
    this.title.textContent = 'Выберите никнейм';
    this.label = document.createElement('label');
    this.label.classList.add('modal__label', 'visually-hidden');
    this.label.for = 'name';
    this.label.textContent = 'Выберите никнейм';
    this.input = document.createElement('input');
    this.input.classList.add('modal__input');
    this.input.id = 'name';
    this.input.type = 'text';
    this.input.placeholder = 'Выберите никнейм';
    this.input.required = true;
    ...
    this.button.textContent = 'Войти в чат';
...
;// ./src/components/serverError/ServerError.js
...
var ServerError = /*#__PURE__*/ServerError_createClass(function ServerError(status) {
  ...
  this.element.textContent = "\u041E\u0448\u0438\u0431\u043A\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0430 - ".concat(status, ". \u041C\u043E\u0436\u0435\u0442 \u0431\u044B\u0442\u044C \u043F\u043E\u0437\u0436\u0435 \u0437\u0430\u0439\u0434\u0435\u0448\u044C?...");
  document.body.append(this.element);
});

;// ./src/libs/createRequest.js
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          baseUrl = 'https://ahj-websockets-backend.onrender.com';
    ...
    value: function connectToWebSocket() {
      ...
      this.ws.addEventListener('message', function (event) {
        ...
        if (data.type === 'send') {
          ...
          _this2.chatContainer.addMessage(info, data.msg, name === 'You'); // 'Anita, 20:50 19.09.2024', 'Hi!', true
          _this2.chatContainer.resetForm();
          return;
        }
        _this2.usersContainer.deleteUsers();
        data.forEach(function (user) {
          var name = user.id === _this2.currentId ? 'You' : user.name;
          _this2.usersContainer.addUser(name);
        });
      });
    }
  }, {
